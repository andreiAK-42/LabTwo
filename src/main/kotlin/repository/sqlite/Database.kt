...
class ResourceRepository(
    @Value("\${app.db.url:jdbc:sqlite:top-secret.db}") private val url: String = "jdbc:sqlite:top-secret.db"
) {
    ...
    private fun getResourceByName(name: String): Pair<Resource?, ResponseCode> {
        val connection: Connection = DriverManager.getConnection(url)
